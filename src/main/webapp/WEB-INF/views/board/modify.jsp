		...
		$.getJSON("/board/getAttachList", {bno:bno}, function(arr){
			...
			$(arr).each(function(i, attach){
				...
				if(attach.fileType){
					...
					str += "<li data-path='"+attach.uploadPath+"' data-uuid='"+attach.uuid+"' data-filename='"+attach.fileName+"' data-type='"+attch.fileType+"' ><div>";
					str += "<span> " +attach.fileName+"</span><br/>";
					str += "<button type='button' data-file=\'"+fileCallPath+"\' data-type='file' "
					str += " class='btn btn-warning btn-circle'><i clas='fa fa-times'></li></button><br>";
